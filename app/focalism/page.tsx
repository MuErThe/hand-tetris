    ...
    <main className="flex-1 overflow-y-auto overflow-x-hidden">
      ...
      <div className="min-h-full flex flex-col items-center px-5 py-10 md:py-14">
        <article className="w-full" style={{ maxWidth: 760 }}>
          ...
          <div className="font-display text-[10px] tracking-[0.14em] mt-8 mb-3" style={{ color: "var(--accent)" }}> a manifesto </div>
          <h1
            className="font-display tracking-[0.07em] leading-tight mb-5"
          ...
          <h2 className="font-display text-[14px] tracking-[0.1em] mb-5" style={{ color: "var(--accent)" }}>
            The six laws
          </h2>
          <ol className="flex flex-col gap-5 mb-12">
            {LAWS.map((law) => (
              <li key={law.n} className="rounded-[6px] border px-5 py-4" style={{ borderColor: "var(--panel-border)", background: "var(--field-1)" }}>
                <h3 className="font-display text-[13px] tracking-[0.08em] mb-1.5" style={{ color: "var(--ink)" }}>
                  <span style={{ color: "var(--accent)" }}>{law.n}</span> · {law.title}
                </h3>
          ...
          <h2 className="font-display text-[14px] tracking-[0.1em] mb-2" style={{ color: "var(--accent)" }}>
            Specimens
          </h2>
          ...
          <pre
            className="rounded-[6px] border px-4 py-4 overflow-x-auto font-mono text-[11px] leading-relaxed mb-10"
...
/* Rules of thumb:
   ...
   - prefers-reduced-motion: fades instead of racks */`}</pre>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/about"
              className="inline-block font-mono tracking-[0.1em] text-[11px] px-5 py-3 border transition-colors hover:text-[var(--ink)]"
